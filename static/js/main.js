      ...
      slides: [
        {
          ...
          tag: "АСУ ТП",
          bg: "url(images/hero-industrial.webp) center/cover no-repeat",
        },
        {
          ...
          tag: "Оборудование",
          bg: "url(images/hero-supply.webp) center/cover no-repeat",
        },
        {
          ...
          tag: "Smart Home",
          bg: "url(images/hero-smarthome.webp) center/cover no-repeat",
        },
        {
          ...
          tag: "Сервис",
          bg: "url(images/hero-service.webp) center/cover no-repeat",
        },
      ],
      timer: null,
      init: function () {
